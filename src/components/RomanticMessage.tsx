  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-100 via-pink-100 to-purple-100 p-6">
      <div className="max-w-3xl text-center fade-in">
        ...
        <div className="space-y-8 text-xl md:text-2xl text-gray-700 font-poppins leading-relaxed">
          ...
          <p className="animate-fade-in-delay-4 text-2xl md:text-3xl text-rose-700 font-semibold">
        ...
        <button
          onClick={onNext}
          className="mt-12 px-10 py-5 bg-gradient-to-r from-rose-500 to-pink-600 text-white rounded-full text-xl font-poppins shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 glow-button animate-fade-in-delay-5"
        >
          One More Thing... 💗
        </button>
      </div>
